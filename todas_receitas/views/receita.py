...
def index(request):
    """Visualiza a página inicial com todas receitas."""
...
def receita(request, receita_id):
    """Visualiza uma receita individual."""
...
def atualizar_receita(request):
    """Atualiza uma receita para o usuário logado."""
    if request.method == 'POST':
...
def deletar_receita(request, receita_id):
    """Deleta uma receita para o usuário logado."""
    receita = get_object_or_404(Receita, pk=receita_id)
    receita.delete()
    return redirect('dashboard')
...
def editar_receita(request, receita_id):
    """Edita uma receita para o usuário logado."""
    receita = get_object_or_404(Receita, pk=receita_id)
